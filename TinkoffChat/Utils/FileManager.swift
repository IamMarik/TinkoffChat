...
/// Все методы класса static, а также не зависит от пользовательских данных/классов,
/// поэтому не считаю необходимым инжектить как зависимость, вызываю методы напрямую при необходимости
class FileUtils {
